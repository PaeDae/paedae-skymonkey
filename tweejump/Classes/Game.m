...
- (void)showHighscores {
	NSLog(@"%s - showing high score: %d", __FUNCTION__, score);
    ...
    if (score >= 1000 && score < 5000) {
        ...
        achievementId = @"com.skymonkey.10000.earned";
    } else if (score >= 20000 && score < 50000) {
        achievementId = @"com.skymonkey.20000.earned";
    } else if (score >= 50000 && score < 100000) {
        achievementId = @"com.skymonkey.50000.earned";
    } else if (score >= 100000 && score < 250000) {
        achievementId = @"com.skymonkey.100000.earned";
    } else if (score >= 250000 && score < 500000) {
        achievementId = @"com.skymonkey.250000.earned";
    } else if (score >= 500000 && score < 750000) {
        achievementId = @"com.skymonkey.500000.earned";
    } else if (score > 750000 && score < 1000000) {
        achievementId = @"com.skymonkey.750000.earned";
